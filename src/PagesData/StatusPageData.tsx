...
export const recentData = {
	labels: ['47', '50', '55', '57', '59', '61', '62', '63', '64', '66', '67', '68', '71', '72', '73', '74', '76', '77', '78', '80', '81', '83', '84', '85', '86', '87', '88', '89', '90', '91', '92', '93', '95', '96', '97', '98', '99', '100', '101', '107', '108', '109', '111', '112', '113', '114', '115', '116', '117', '120', '121', '122', '124', '128', '129', '130', '132', '133', '135', '136', '138', '140', '141', '144', '147', '149', '150', '154'],
	datasets: [
		{
			label: "Killed Children in Gaza",
			data: [6150, 6150, 6150, 6600, 6600, 7729, 7870, 7870, 7875, 8000, 8000, 8000, 8000, 8000, 8000, 8000, 8000, 8200, 8200, 8200, 8800, 8880, 9000, 9000, 9000, 9000, 9280, 9730, 9730, 10000, 10000, 10000, 10000, 10300, 10300, 10400, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12345, 12660, 12660, 12660, 12660, 12660, 12660, 12660, 13430, 13430],
			backgroundColor: "#990a0a",
